...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 26, 2019 at 07:03 AM
...
(1, 'admin', '$2y$12$i4LMfeFPQpGSNPTaccIkKuwxAkJ4PhBr3JND7FpXwWFjRvchQn17C', 'admin@gmail.com', 1, '2019-05-27 17:51:00', '2021-02-30 18:21:07');

INSERT INTO `tbladmin` (`id`, `AdminUserName`, `AdminPassword`, `AdminEmailId`, `Is_Active`, `CreationDate`, `UpdationDate`) VALUES
(2, 'admin2', '$2y$12$i4LMfeFPQpGSNPTaccIkKuwxAkJ4PhBr3JND7FpXwWFjRvchQn17C', 'admin2@gmail.com', 1, '2019-05-27 17:51:00', '2021-03-30 18:21:07');
...
DROP TABLE IF EXISTS `tblsubadmin`;
CREATE TABLE IF NOT EXISTS `tblsubadmin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `AdminUserName` varchar(255) NOT NULL,
  `AdminPassword` varchar(255) NOT NULL,
  `AdminEmailId` varchar(255) NOT NULL,
...
INSERT INTO `tblsubadmin` (`id`, `AdminUserName`, `AdminPassword`, `AdminEmailId`, `Is_Active`, `CreationDate`, `UpdationDate`) VALUES
(1, 'subadmin', '$2y$12$i4LMfeFPQpGSNPTaccIkKuwxAkJ4PhBr3JND7FpXwWFjRvchQn17C', 'noidatut3@gmail.com', 1, '2019-05-27 17:51:00', '2019-05-30 18:21:07');
INSERT INTO `tblsubadmin` (`id`, `AdminUserName`, `AdminPassword`, `AdminEmailId`, `Is_Active`, `CreationDate`, `UpdationDate`) VALUES
(2, 'subadmin2', '$2y$12$i4LMfeFPQpGSNPTaccIkKuwxAkJ4PhBr3JND7FpXwWFjRvchQn17C', 'noidatut4@gmail.com', 1, '2019-05-27 17:51:00', '2019-05-30 18:21:07');
INSERT INTO `tblsubadmin` (`id`, `AdminUserName`, `AdminPassword`, `AdminEmailId`, `Is_Active`, `CreationDate`, `UpdationDate`) VALUES
(3, 'subadmin4', '$2y$12$i4LMfeFPQpGSNPTaccIkKuwxAkJ4PhBr3JND7FpXwWFjRvchQn17C', 'noidatut5@gmail.com', 1, '2019-05-27 17:51:00', '2019-05-30 18:21:07');
-- --------------------------------------------------------
...
(1, 'aboutus', 'About News Portal', '<font color=\"#7b8898\" face=\"Mercury SSm A, Mercury SSm B, Georgia, Times, Times New Roman, Microsoft YaHei New, Microsoft Yahei, å¾®è½¯é›…é»‘, å®‹ä½“, SimSun, STXihei, åŽæ–‡ç»†é»‘, serif\"><span style=\"font-size: 26px;\">Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum Lorem Ipsum Dollar Sum .\r\n\r\nIf you wish to contact us or locate us Please find us here on google maps. We would request you to write the reviews on google to help us reach different people. </span></font><br>', '2018-06-30 18:01:03', '2019-06-26 06:38:54'),
(2, 'contactus', 'Contact Details', '<p><br></p><p><b>Address :&nbsp; </b>Dhaka Bangladesh</p><p><b>Phone Number : </b>+88 -01234567890</p><p><b>Email -id : </b>3decktechhub@gmail.com</p>', '2018-06-30 18:01:36', '2018-06-30 19:23:25');
...
DROP TABLE IF EXISTS `tblapprove`;
CREATE TABLE IF NOT EXISTS `tblapprove` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `PostTitle` longtext,
  `CategoryId` int(11) DEFAULT NULL,
  `SubCategoryId` int(11) DEFAULT NULL,
