        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo"><span>NP<span>Admin2</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
									 <li>
                                            <a href="https://www.projectnotes.org" target="_blank">ProjectNotes</a>
                                        </li>
                                        <li>
                                            <a  href="https://www.projectnotes.org" target="_blank">NewsPortal</a>
                                        </li>
                                        <li>
