...
$sql =mysqli_query($con,"SELECT AdminUserName,AdminEmailId,AdminPassword FROM tblsubadmin WHERE (AdminUserName='$uname' || AdminEmailId='$uname')");
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    enable_page_level_ads: true
        ...
        <!-- App title -->
        <title>News Portal | Sub-Admin Panel</title>
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="assets/images/logologo.png" alt="" height="56"></span>
                                        </a>
                                    </h2>
